...
### Expected Backend Organization (per PRD)
...
├── config/            # Configuration files (DB, JWT, email, etc.)
├── models/            # Mongoose schemas and models
│   ├── plugins/       # Mongoose plugins (e.g., soft delete, timestamps)
│   ├── Organization.js
│   ├── Department.js
│   ├── User.js
│   ├── Task.js        # Base task with discriminators
│   ├── TaskActivity.js
│   ├── TaskComment.js
│   ├── Material.js
│   ├── Vendor.js
...
### Expected Frontend Organization (per PRD)
...
│   │   ├── DashboardLayout/        # Header, sidebar, bottom nav, content
│   │   │   ├── Header.jsx          # Logo, search, notifications, profile
│   │   │   ├── Sidebar.jsx         # Navigation menu (desktop/tablet)
│   │   │   ├── BottomNavigation.jsx # Mobile nav with centered FAB
│   │   │   └── index.jsx
...
│   │   ├── TaskList.jsx            # List view (cards) with tabs
│   │   ├── TaskGrid.jsx            # Grid view (MuiDataGrid wrapper)
│   │   ├── TaskCard.jsx            # Task summary card for list view
│   │   ├── TaskDetails.jsx         # Task detail page
│   │   ├── TaskForm.jsx            # Create/update dialog
│   │   ├── TaskFilters.jsx         # Filter dialog
│   │   ├── TaskActivity.jsx        # Activity timeline
│   │   ├── TaskComments.jsx        # Comments section
│   │   └── TaskAttachments.jsx     # Attachments section
│   ├── user/                       # User management components
│   │   ├── UserList.jsx            # List view (cards)
│   │   ├── UserGrid.jsx            # Grid view (MuiDataGrid wrapper)
│   │   ├── UserCard.jsx            # User summary card for list view
│   │   ├── UserDetails.jsx         # User detail page
│   │   ├── UserForm.jsx            # Create/update dialog
│   │   ├── UserFilters.jsx         # Filter dialog
│   │   ├── UserActivity.jsx        # Activity feed
│   │   ├── UserPerformance.jsx     # Performance metrics
│   │   └── UserTasks.jsx           # User tasks tab
│   ├── department/                 # Department components
│   │   ├── DepartmentList.jsx      # List view (cards)
│   │   ├── DepartmentGrid.jsx      # Grid view (MuiDataGrid wrapper)
│   │   ├── DepartmentCard.jsx      # Department summary card for list view
│   │   ├── DepartmentDetails.jsx   # Department detail page
│   │   ├── DepartmentForm.jsx      # Create/update dialog
│   │   ├── DepartmentFilters.jsx   # Filter dialog
│   │   ├── DepartmentOverview.jsx  # Overview tab
│   │   ├── DepartmentUsers.jsx     # Users tab
│   │   ├── DepartmentTasks.jsx     # Tasks tab
│   │   └── DepartmentActivity.jsx  # Activity tab
│   ├── vendor/                     # Vendor components
│   │   ├── VendorGrid.jsx          # Grid view only (MuiDataGrid wrapper, no list view)
│   │   ├── VendorDetails.jsx       # Vendor detail page
│   │   └── VendorForm.jsx          # Create/update dialog
│   ├── material/                   # Material components
│   │   ├── MaterialGrid.jsx        # Grid view only (MuiDataGrid wrapper, no list view)
│   │   ├── MaterialDetails.jsx     # Material detail page
│   │   ├── MaterialForm.jsx        # Create/update dialog
│   │   └── RestockDialog.jsx       # Restock dialog
│   ├── attachment/                 # File attachment components
│   │   ├── FileUpload.jsx          # Drag-and-drop upload
│   │   ├── FilePreview.jsx         # Image preview
│   │   ├── FileList.jsx            # Attachment list
...
│   ├── reusable/                   # Reusable MUI wrappers (REQUIRED)
│   │   ├── MuiDataGrid.jsx         # Reusable DataGrid wrapper
│   │   ├── MuiDataGridToolbar.jsx  # Shared toolbar for DataGrid
│   │   ├── MuiLoading.jsx          # Loading component
│   │   └── index.js                # Export all reusable components
...
│       ├── UpcomingDeadlines.jsx   # Deadlines table
│       └── TeamPerformance.jsx     # Performance widget
├── pages/                          # Route pages
│   ├── Home.jsx                    # Landing page
│   ├── Login.jsx                   # Login page
│   ├── Register.jsx                # 4-step onboarding wizard
│   │                               # Step 1: Org details
│   │                               # Step 2: Dept setup
...
│   ├── Departments.jsx             # Department list/grid
│   ├── DepartmentDetails.jsx       # Department detail page
│   ├── Users.jsx                   # User list/grid
│   ├── UserDetails.jsx             # User detail page
│   ├── Tasks.jsx                   # Task list/grid
│   ├── TaskDetails.jsx             # Task detail page
│   ├── Materials.jsx               # Material list
│   ├── MaterialDetails.jsx         # Material detail page
│   ├── Vendors.jsx                 # Vendor list
│   ├── VendorDetails.jsx           # Vendor detail page
│   ├── Settings.jsx                # User settings (profile, account, security)
│   └── NotFound.jsx                # 404 page
├── redux/                          # Redux store (currently at client/redux, should move to src/)
│   ├── app/                        # Store configuration
│   │   └── store.js                # Store configuration with redux-persist
│   └── features/                   # Feature slices
│       ├── authSlice.js            # Auth state
│       ├── taskSlice.js            # Task UI state
│       ├── userSlice.js            # User UI state
│       ├── departmentSlice.js      # Department UI state
│       ├── notificationSlice.js    # Notification state
│       └── themeSlice.js           # Theme preferences
├── services/                       # API services (currently at client/services, should move to src/)
│   ├── api.js                      # RTK Query API setup
│   │                               # Endpoints: auth, organizations, departments,
│   │                               # users, tasks, materials, vendors, attachments,
│   │                               # notifications, dashboard
│   └── socketService.js            # Socket.IO client with event handlers
├── hooks/                          # Custom React hooks (currently at client/hooks, should move to src/)
│   ├── useAuth.js                  # Authentication hook
│   ├── useSocket.js                # Socket.IO hook
│   ├── useAuthorization.js         # RBAC authorization hook
│   ├── useTimezone.js              # Timezone handling hook
│   ├── useResponsive.js            # Responsive breakpoint hook
│   ├── useDebounce.js              # Debounce hook for search
│   └── useInfiniteScroll.js        # Infinite scroll hook
├── utils/                          # Utility functions (currently at client/utils, should move to src/)
│   ├── constants.js                # Enums, patterns, limits
│   ├── validators.js               # Form validation helpers
│   ├── authorization.js            # RBAC helper functions
│   ├── dateUtils.js                # Date formatting (Intl API)
│   ├── fileUtils.js                # File validation and upload
│   └── errorHandlers.js            # Error handling utilities
├── router/                         # Routing configuration
│   └── routes.jsx                  # Route definitions with lazy loading
└── theme/                          # MUI theme
    ├── AppTheme.jsx                # Theme provider with mode toggle
    ├── themePrimitives.js          # Design tokens (colors, spacing, typography)
    └── customizations/             # Component overrides
        ├── charts.js               # MUI X Charts customization
        ├── dataDisplay.js          # Typography, Avatar, Badge, etc.
        ├── dataGrid.js             # MUI X DataGrid customization
        ├── datePickers.js          # MUI X DatePickers customization
        ├── feedback.js             # Alert, Snackbar, Progress, etc.
        ├── inputs.js               # TextField, Select, Checkbox, etc.
        ├── navigation.js           # Drawer, Menu, Tabs, etc.
        ├── surfaces.js             # Paper, Card, Accordion, etc.
        └── index.js                # Export all customizations
```

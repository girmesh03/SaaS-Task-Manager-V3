...
/**
 * Tasks grid-mode renderer (DataGrid + server pagination/sorting).
 *
 * @param {{
 ...
 * @returns {JSX.Element} Tasks grid view.
...
const TasksGridView = ({
  ...
  return (
    <MuiDataGrid
      ...
      emptyStateSecondaryMessage="Try adjusting filters or create a new task."
      sortingMode="server"
      sortModel={sortModel}
